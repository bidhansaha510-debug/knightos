...
export default function Settings() {
  ...
  return (
    <div style={{ maxWidth: 640, margin: '0 auto', padding: 'var(--space-5) var(--space-4)' }}>
      <h1 style={{ fontSize: 'var(--text-lg)', fontWeight: 'var(--weight-bold)', color: 'var(--c-text)', marginBottom: 'var(--space-6)' }}>
        Settings
      </h1>
        ...
        <div style={{ display: 'flex', gap: 'var(--space-2)', flexWrap: 'wrap' }}>
          {BOARD_THEMES.map((theme) => (
            <button
              ...
              style={{
                padding: 'var(--space-3)',
                border: `1px solid ${boardTheme === theme.key ? 'var(--c-accent)' : 'var(--c-border)'}`,
            ...
            >
              ...
              <p style={{ fontSize: 'var(--text-xs)', color: 'var(--c-text)', fontWeight: 'var(--weight-medium)' }}>
                {theme.label}
              </p>
            </button>
          ))}
        ...
        <div style={{ display: 'flex', gap: 'var(--space-2)', flexWrap: 'wrap' }}>
          {PIECE_SETS.map((set) => (
            <button
              ...
              style={{
                padding: 'var(--space-3)',
                border: `1px solid ${pieceSet === set.key ? 'var(--c-accent)' : 'var(--c-border)'}`,
                borderRadius: 'var(--radius-md)',
            ...
            >
              ...
              <p style={{ fontSize: 'var(--text-xs)', color: 'var(--c-text)', fontWeight: 'var(--weight-medium)', marginTop: 'var(--space-1)' }}>
                {set.label}
              </p>
            </button>
          ))}
      ...
      <section style={{ marginBottom: 'var(--space-6)' }}>
        ...
        {[
          ...
          >
            <div>
              <p style={{ fontSize: 'var(--text-sm)', fontWeight: 'var(--weight-medium)', color: 'var(--c-text)' }}>{pref.label}</p>
              <p style={{ fontSize: 'var(--text-xs)', color: 'var(--c-text-2)' }}>{pref.desc}</p>
            </div>
